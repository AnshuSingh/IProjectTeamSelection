...
public class FacultyWrapper implements Faculty, ModelWrapper<Faculty> {
	...
	*/
	...
	/**
	* Returns the asuriteid of this faculty.
	*
	* @return the asuriteid of this faculty
	*/
	public java.lang.String getAsuriteid() {
		return _faculty.getAsuriteid();
	}

	/**
	* Sets the asuriteid of this faculty.
	*
	* @param asuriteid the asuriteid of this faculty
	*/
	public void setAsuriteid(java.lang.String asuriteid) {
		_faculty.setAsuriteid(asuriteid);
	}
	...
	*/
	...
	/**
	* Returns the assigned of this faculty.
	*
	* @return the assigned of this faculty
	*/
	public boolean getAssigned() {
		return _faculty.getAssigned();
	}

	/**
	* Returns <code>true</code> if this faculty is assigned.
	*
	* @return <code>true</code> if this faculty is assigned; <code>false</code> otherwise
	*/
	public boolean isAssigned() {
		return _faculty.isAssigned();
	}

	/**
	* Sets whether this faculty is assigned.
	*
	* @param assigned the assigned of this faculty
	*/
	public void setAssigned(boolean assigned) {
		_faculty.setAssigned(assigned);
	}
	...
	public int compareTo(com.subscriberapprove.model.Faculty faculty) {
	...
	public com.liferay.portal.model.CacheModel<com.subscriberapprove.model.Faculty> toCacheModel() {
		return _faculty.toCacheModel();
	}

	public com.subscriberapprove.model.Faculty toEscapedModel() {
