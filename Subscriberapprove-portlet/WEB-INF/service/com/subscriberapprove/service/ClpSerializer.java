...
import com.subscriberapprove.model.FacultyClp;
import com.subscriberapprove.model.studentClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"Subscriberapprove-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "Subscriberapprove-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.subscriberapprove.model.impl.FacultyImpl")) {
			return translateOutputFaculty(oldModel);
		}

		if (oldModelClassName.equals(
					"com.subscriberapprove.model.impl.studentImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.subscriberapprove.NoSuchFacultyException")) {
			return new com.subscriberapprove.NoSuchFacultyException();
		}

		if (className.equals("com.subscriberapprove.NoSuchstudentException")) {
			return new com.subscriberapprove.NoSuchstudentException();
		}
