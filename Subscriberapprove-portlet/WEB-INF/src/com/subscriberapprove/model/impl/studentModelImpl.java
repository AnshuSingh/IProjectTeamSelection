...
import com.subscriberapprove.model.studentModel;
import com.subscriberapprove.model.studentSoap;
...
/**
 * The base model implementation for the student service. Represents a row in the &quot;Sapprove_student&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.subscriberapprove.model.studentModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link studentImpl}.
 * </p>
 *
 * @author Shruthi
 * @see studentImpl
 * @see com.subscriberapprove.model.student
 * @see com.subscriberapprove.model.studentModel
 * @generated
 */
@JSON(strict = true)
public class studentModelImpl extends BaseModelImpl<student>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a student model instance should use the {@link com.subscriberapprove.model.student} interface instead.
	 */
	public static final String TABLE_NAME = "Sapprove_student";
	...
	public static final String TABLE_SQL_CREATE = "create table Sapprove_student (studentgeninfoid LONG not null primary key,firstName VARCHAR(75) null,lastName VARCHAR(75) null,asuriteid VARCHAR(75) null,department VARCHAR(75) null,level VARCHAR(75) null,cgpa VARCHAR(75) null,sex VARCHAR(75) null,phone VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,assigned BOOLEAN)";
	public static final String TABLE_SQL_DROP = "drop table Sapprove_student";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.subscriberapprove.model.student"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.subscriberapprove.model.student"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.subscriberapprove.model.student"));
	...
	public Object clone() {
		...
		studentImpl.setAssigned(getAssigned());
	...
	public CacheModel<student> toCacheModel() {
		...
		studentCacheModel.assigned = getAssigned();
