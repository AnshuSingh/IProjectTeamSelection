...
import com.subscriberapprove.NoSuchFacultyException;

import com.subscriberapprove.model.Faculty;
import com.subscriberapprove.model.impl.FacultyImpl;
import com.subscriberapprove.model.impl.FacultyModelImpl;
...
public class FacultyPersistenceImpl extends BasePersistenceImpl<Faculty>
	...
	@Override
	public Faculty updateImpl(com.subscriberapprove.model.Faculty faculty,
	...
	protected Faculty toUnwrappedModel(Faculty faculty) {
		...
		facultyImpl.setAsuriteid(faculty.getAsuriteid());
		...
		facultyImpl.setAssigned(faculty.isAssigned());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.subscriberapprove.model.Faculty")));
