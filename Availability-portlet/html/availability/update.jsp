<%@ include file="/html/availability/init.jsp" %>
<html>
<h1>Student Availability</h1>
<%
PortletURL studentAvailabilityURL = renderResponse.createActionURL();
studentAvailabilityURL.setParameter(ActionRequest.ACTION_NAME, "studentAvailability");
%>

<form name="<portlet:namespace/>fm" method="POST" action="<%=studentAvailabilityURL.toString() %>">
