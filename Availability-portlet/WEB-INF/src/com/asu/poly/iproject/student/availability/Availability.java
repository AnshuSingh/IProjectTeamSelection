package com.asu.poly.iproject.student.availability;
...
/**
 * Portlet implementation class Availability
 */
public class Availability extends MVCPortlet {
		...
		public void studentAvailability(ActionRequest actionRequest,ActionResponse actionResponse)
				throws IOException, PortletException 
				{
			      ...
			      SASstudent student = new SASstudentImpl();
			      long studentId = 0L;
			      try 
			      {
