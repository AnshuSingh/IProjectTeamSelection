 ...
 * @generated
 */
public class SASstudentSoap implements Serializable {
	public static SASstudentSoap toSoapModel(SASstudent model) {
		SASstudentSoap soapModel = new SASstudentSoap();
	...
	public static SASstudentSoap[] toSoapModels(SASstudent[] models) {
		SASstudentSoap[] soapModels = new SASstudentSoap[models.length];
	...
	public static SASstudentSoap[][] toSoapModels(SASstudent[][] models) {
		SASstudentSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new SASstudentSoap[models.length][models[0].length];
		}
		else {
			soapModels = new SASstudentSoap[0][0];
		}
	...
	public static SASstudentSoap[] toSoapModels(List<SASstudent> models) {
		List<SASstudentSoap> soapModels = new ArrayList<SASstudentSoap>(models.size());

		for (SASstudent model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new SASstudentSoap[soapModels.size()]);
	}

	public SASstudentSoap() {
	}
