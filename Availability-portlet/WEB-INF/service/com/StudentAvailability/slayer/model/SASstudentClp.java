 ...
 * @author Purva
 */
public class SASstudentClp extends BaseModelImpl<SASstudent>
	implements SASstudent {
	public SASstudentClp() {
	}
	...
	public BaseModel<?> getSASstudentRemoteModel() {
		return _saSstudentRemoteModel;
	}

	public void setSASstudentRemoteModel(BaseModel<?> saSstudentRemoteModel) {
		_saSstudentRemoteModel = saSstudentRemoteModel;
	}

	public void persist() throws SystemException {
		if (this.isNew()) {
			SASstudentLocalServiceUtil.addSASstudent(this);
		}
		else {
			SASstudentLocalServiceUtil.updateSASstudent(this);
		}
	}

	@Override
	public SASstudent toEscapedModel() {
		return (SASstudent)Proxy.newProxyInstance(SASstudent.class.getClassLoader(),
			new Class[] { SASstudent.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		SASstudentClp clone = new SASstudentClp();
	...
	public boolean equals(Object obj) {
		...
		SASstudentClp saSstudent = null;

		try {
			saSstudent = (SASstudentClp)obj;
		}
	...
	private BaseModel<?> _saSstudentRemoteModel;
}