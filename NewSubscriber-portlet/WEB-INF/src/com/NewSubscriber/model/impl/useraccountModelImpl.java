...
import com.NewSubscriber.model.useraccountModel;
import com.NewSubscriber.model.useraccountSoap;
...
/**
 * The base model implementation for the useraccount service. Represents a row in the &quot;NS_useraccount&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.NewSubscriber.model.useraccountModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link useraccountImpl}.
 * </p>
 *
 * @author Shruthi
 * @see useraccountImpl
 * @see com.NewSubscriber.model.useraccount
 * @see com.NewSubscriber.model.useraccountModel
 * @generated
 */
@JSON(strict = true)
public class useraccountModelImpl extends BaseModelImpl<useraccount>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a useraccount model instance should use the {@link com.NewSubscriber.model.useraccount} interface instead.
	 */
	public static final String TABLE_NAME = "NS_useraccount";
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "level", Types.VARCHAR },
			{ "sex", Types.VARCHAR },
			{ "userapproved", Types.BOOLEAN },
			{ "dateAdded", Types.TIMESTAMP }
		};
	public static final String TABLE_SQL_CREATE = "create table NS_useraccount (useraccountId LONG not null primary key IDENTITY,companyId LONG,firstName VARCHAR(75) null,lastName VARCHAR(75) null,eMail VARCHAR(75) null,phoneNo VARCHAR(75) null,major VARCHAR(75) null,cgpa VARCHAR(75) null,role VARCHAR(75) null,password_ VARCHAR(75) null,asuriteId VARCHAR(75) null,level VARCHAR(75) null,sex VARCHAR(75) null,userapproved BOOLEAN,dateAdded DATE null)";
	public static final String TABLE_SQL_DROP = "drop table NS_useraccount";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.NewSubscriber.model.useraccount"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.NewSubscriber.model.useraccount"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.NewSubscriber.model.useraccount"));
	...
	public Object clone() {
		...
		useraccountImpl.setUserapproved(getUserapproved());
	...
	public CacheModel<useraccount> toCacheModel() {
		...
		useraccountCacheModel.userapproved = getUserapproved();
