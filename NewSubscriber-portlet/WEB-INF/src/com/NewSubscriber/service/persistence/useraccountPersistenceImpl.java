...
import com.NewSubscriber.NoSuchuseraccountException;

import com.NewSubscriber.model.impl.useraccountImpl;
import com.NewSubscriber.model.impl.useraccountModelImpl;
...
public class useraccountPersistenceImpl extends BasePersistenceImpl<useraccount>
	...
	protected useraccount toUnwrappedModel(useraccount useraccount) {
		...
		useraccountImpl.setUserapproved(useraccount.isUserapproved());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.NewSubscriber.model.useraccount")));
