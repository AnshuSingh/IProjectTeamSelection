...
public class studentWrapper implements student, ModelWrapper<student> {
	...
	*/
	...
	/**
	* Returns the loggedinuser ID of this student.
	*
	* @return the loggedinuser ID of this student
	*/
	public long getLoggedinuserId() {
		return _student.getLoggedinuserId();
	}

	/**
	* Sets the loggedinuser ID of this student.
	*
	* @param loggedinuserId the loggedinuser ID of this student
	*/
	public void setLoggedinuserId(long loggedinuserId) {
		_student.setLoggedinuserId(loggedinuserId);
	}
