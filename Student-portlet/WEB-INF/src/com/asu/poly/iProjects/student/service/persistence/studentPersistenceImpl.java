...
import com.asu.poly.iProjects.student.NoSuchstudentException;
import com.asu.poly.iProjects.student.model.impl.studentImpl;
import com.asu.poly.iProjects.student.model.impl.studentModelImpl;
...
public class studentPersistenceImpl extends BasePersistenceImpl<student>
	...
	protected student toUnwrappedModel(student student) {
		...
		studentImpl.setLoggedinuserId(student.getLoggedinuserId());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.asu.poly.iProjects.student.model.student")));
