...
import com.asu.poly.iProjects.student.NoSuchpreferencesException;
import com.asu.poly.iProjects.student.model.impl.preferencesImpl;
import com.asu.poly.iProjects.student.model.impl.preferencesModelImpl;
...
public class preferencesPersistenceImpl extends BasePersistenceImpl<preferences>
	...
	protected preferences toUnwrappedModel(preferences preferences) {
		...
		preferencesImpl.setAsuriteid(preferences.getAsuriteid());
		...
		preferencesImpl.setStudentasuid(preferences.getStudentasuid());
		preferencesImpl.setFocusarea(preferences.getFocusarea());
		preferencesImpl.setReasons(preferences.getReasons());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.asu.poly.iProjects.student.model.preferences")));
